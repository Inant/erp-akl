...
<div class="page-breadcrumb">
    <div class="row">
        <div class="col-5 align-self-center">
            <h4 class="page-title">Pengeluaran Alat Bantu Kerja</h4>
            <div class="d-flex align-items-center">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item active" aria-current="page">Pengeluaran Alat Bantu Kerja</li>
                    </ol>
                </nav>
            </div>
        </div>
...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">List Pengeluaran Alat Bantu Kerja</h4>
...
<form method="POST" action="{{ URL::to('pengeluaran_alat_kerja') }}" class="form-horizontal">
    @csrf
        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="myLargeModalLabel">Material Pengeluaran Alat Bantu Kerja</h4>
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                </div>
                <div class="modal-body">
                    <h4>Alat Bantu Kerja Request Detail</h4>
                    <div class="table-responsive">
...
$(document).ready(async function(){
    ...
    $.ajax({
            type: "GET",
            url: "{{ URL::to('pengeluaran_alat_kerja/list') }}", //json get site
            dataType : 'json',
            success: function(response){
                arrData = response['data'];
...
function clickRequest() {
    ...
    if (mandor.checkValidity()) {
        setTimeout(() => {
            window.open("{{ URL::to('pengeluaran_alat_kerja/print') }}" + "/" + idRequest, '_blank')
        }, 500);
    }
}
