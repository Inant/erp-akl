...
<body>
    <div class="main-wrapper">
        ...
        <!-- Login box.scss -->
        <!-- ============================================================== -->
        <div class="auth-wrapper d-flex no-block justify-content-center align-items-center" style="background:url({!! asset('theme/assets/images/big/auth-bg.jpg') !!}) no-repeat center center;">
            <div class="auth-box">
                <div id="loginform">
                    <div class="logo">
                        ...
                        <div class="col-12">
                            ...
                            <form method="POST" action="{{ route('login') }}"> 
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input id="email" type="email" class="form-control form-control-lg" name="email" value="{{ old('email') }}" placeholder="Username" aria-label="Username" aria-describedby="basic-addon1" required autofocus>
                                    @if ($errors->has('email'))
