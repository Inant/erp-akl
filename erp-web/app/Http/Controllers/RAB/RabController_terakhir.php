...
class RabController extends Controller
{
    ...
    public function exportMaterial($id){
        $rab=DB::table('rabs')
                    ->select('rabs.no as rab_no', 'projects.name as project_name', 'orders.spk_number as spk_number', 'kavlings.name as kavling_name', 'kavlings.id as kavling_id', 'rabs.order_id')
                    ->join('projects', 'projects.id', 'rabs.project_id')
                    ->join('kavlings', 'kavlings.id', 'rabs.kavling_id')
                    ->join('orders', 'order.id', 'rabs.order_id')
                    ->where('rabs.id', $id)
                    ->first();
