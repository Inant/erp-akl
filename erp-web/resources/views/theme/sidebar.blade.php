                    ...
                    <ul id="sidebarnav">
                        ...
                        <li>
                            ...
                            <div class="user-profile d-flex no-block dropdown mt-3">
                                <div class="user-pic"><img src="{!! asset('theme/assets/images/users/5.jpg') !!}" alt="users" class="rounded-circle" width="40" /></div>
                        ...
                        foreach($main_menus as $main_menu){
                            ...
                            if($main_menu->is_main_menu == 0){
                                echo '<li class="nav-small-cap" style="background-color:#2ab199; color:white"><i class="mdi mdi-dots-horizontal"></i> <span class="hide-menu">'.$main_menu->title.'</span></li>';
                                // Sub Menu 1
                                // Mencari sub menu 1
                                $sub_menu_1 = DB::table('menus')
                                            ->whereIn('id', $array_menu_id)
                                            ->where('is_page_id', null)
                                ...
                                if(count($sub_menu_1) > 0){
                                    foreach($sub_menu_1 as $sub_menu_1_data){
                                        ...
                                        if(count($sub_menu_2) > 0){
                                            echo '<li class="sidebar-item"> <a target="_blank" class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="'.$sub_menu_1_data->icon.'"></i><span class="hide-menu">'.$sub_menu_1_data->title.' </span></a>';
                                            ...
                                            foreach($sub_menu_2 as $sub_menu_2_data){
                                                ...
                                                if(count($sub_menu_3) > 0){                                        
                                                    echo '<li class="sidebar-item"> <a target="_blank" class="has-arrow sidebar-link" href="javascript:void(0)" aria-expanded="false"><i class="'.$sub_menu_2_data->icon.'"></i> <span class="hide-menu">'.$sub_menu_2_data->title.'</span></a>';
                                                    echo '<ul aria-expanded="false" class="collapse second-level">';
                                                    foreach($sub_menu_3 as $sub_menu_3_data){
                                                        echo '<li class="sidebar-item"><a target="_blank" href="'.URL::to($sub_menu_3_data->url).'" class="sidebar-link"><i class="'.$sub_menu_3_data->icon.'"></i><span class="hide-menu"> '.$sub_menu_3_data->title.'</span></a></li>';
                                                    }
                                                    echo '</ul>';
                                                    echo '</li>';
                                                } else {
                                                    echo '<li class="sidebar-item"><a target="_blank" href="'.URL::to($sub_menu_2_data->url).'" class="sidebar-link"><i class="'.$sub_menu_2_data->icon.'"></i><span class="hide-menu"> '.$sub_menu_2_data->title.' </span></a></li>';
                                                }
                                            }
                                            echo '</ul>';
                                            echo '</li>';
                                        } else {
                                            echo '<li class="sidebar-item"> <a target="_blank" class="sidebar-link waves-effect waves-dark" href="'.URL::to($sub_menu_1_data->url).'" aria-expanded="false"><i class="'.$sub_menu_1_data->icon.'"></i><span class="hide-menu">'.$sub_menu_1_data->title.' </span></a>';
                                        }
                                    }
                                }
                            }
