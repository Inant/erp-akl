    ...
    <div class="page-breadcrumb">
        <div class="row">
            <div class="col-5 align-self-center">
                <h4 class="page-title">Tambah Pembayaran Hutang Usaha</h4>
                <div class="d-flex align-items-center">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{ URL::to('/') }}">Pembayaran Hutang Usaha</a></li>
...
<div class="container-fluid">
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Tambah Pembayaran Hutang Usaha</h4>
                    <form method="POST" action="{{ URL::to('payment/save_multiple_paid_debt') }}" class="mt-4" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
...
function getBillSupplier(val){
    ...
    $.ajax({
        url: "{{ URL::to('payment/get_debt_json') }}"+'/'+val,
        dataType : 'json',
        success: function(response){
            ...
            for (let i = 0; i < arrData.length; i++) {
                ...
                $('#list_bill').find('tbody:last').append(
                    '<tr>'+
                        ...
                        '<input type="hidden" name="debt_id[]" id="debt_id[]" value="'+arrData[i]['id']+'"></td>'+
                        '<td>'+arrData[i]['no']+'</td>'+
