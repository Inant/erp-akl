    ...
    <div class="main-wrapper">
        ...
        <div class="error-box">
            <div class="error-body text-center">
                ...
                <p class="text-muted mt-4 mb-4">YOU DON'T HAVE PERMISSION TO ACCESS ON THIS PAGE.</p>
                <a href="{{ URL::to('home') }}" class="btn btn-info btn-rounded waves-effect waves-light mb-5">Back to home</a> </div>
        </div>
        <!-- ============================================================== -->
        <!-- Login box.scss -->
        <!-- ============================================================== -->
