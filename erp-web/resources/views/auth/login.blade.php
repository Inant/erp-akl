...
<body>
    <div class="main-wrapper">
        ...
        <!-- Login box.scss -->
        <!-- ============================================================== -->
        <div class="auth-wrapper d-flex no-block justify-content-center align-items-center" style="background:url({!! asset('theme/assets/images/big/.png') !!}) no-repeat center center;">
            <div class="auth-box">
                <div id="loginform">
                    <div class="logo">
                        ...
                        <div class="col-12">
                            ...
                            <form method="POST" action="{{ route('login') }}"> 
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input id="email" type="email" class="form-control @if ($errors->has('email')) is-invalid @endif form-control-lg" name="email" value="{{ old('email') }}" placeholder="Username" aria-label="Username" aria-describedby="basic-addon1" required autofocus>
                                    @if ($errors->has('email'))
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input id="password" type="password" class="form-control @if ($errors->has('password')) is-invalid @endif form-control-lg" name="password" placeholder="Password" aria-label="Password" aria-describedby="basic-addon1" required>
