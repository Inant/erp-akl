...
<body class="page" onload="window.print()">
    ...
    <table class="table" style="border-collapse:collapse">
        ...
        <tr>
            <td >Lama Jatuh Tempo :</td>
              <td>{{$purchase['credit_age']}} hari</td>
        </tr>
    ...
    <table class="table bordered">
        <tr>
            ...
            <th rowspan="2" class="text-center" style="max-width:80px">Nomor Material</th>
            <th rowspan="2" colspan="4" style="min-width:200px" class="text-center">Deskripsi Barang</th>
        ...
        ?>
            ...
            <tr>
                ...
                <td >{{ $purchase_d[$i]['m_items']['no'] }}</td>
                <td colspan="4">{{ $purchase_d[$i]['m_items']['name'] }}</td>
            ...
            /* if ($purchase['with_ppn'] == null  || $purchase['is_without_ppn'] == null ) {
                $ppn=0;
            }*/
            ?>
            <tr>
