			...
			<div class="page-breadcrumb">
                <div class="row">
                    <div class="col-5 align-self-center">
                        <h4 class="page-title">Laporan Tagihan Supplier</h4>
...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Daftar Laporan Tagihan Supplier</h4>
                    <!-- <div class="row"> -->
                        <form method="POST" action="{{ URL::to('inventory/bill_supplier_recapt') }}">
                            @csrf
                            <div class="row">
                                <div class="col-6">
                    ...
                    <div class="table-responsive">
                        ...
                        <table style="border-collapse:collapse; width:100%">
                            ...
                            @php $sub_total+=$saldo_awal @endphp
...
<div class="modal fade bs-example-modal-lg" id="modalBillDetail" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            ...
            @csrf
            <div class="modal-header">
                <h4 class="modal-title" id="title-modal">Laporan Tagihan Supplier </h4>
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
            </div>
            <div class="modal-body">
                <input type="hidden" name="giro_id" id="giro_id">
                <div class="form-group">
                    <label for="">Total Laporan Tagihan Supplier :</label>
