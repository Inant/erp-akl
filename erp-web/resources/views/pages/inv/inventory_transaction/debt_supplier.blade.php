			...
			<div class="page-breadcrumb">
                <div class="row">
                    <div class="col-5 align-self-center">
                        <h4 class="page-title">Laporan Hutang Supplier</h4>
...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Laporan Hutang Supplier</h4>
                    <!-- <div class="row"> -->
                        <form method="POST" action="{{ URL::to('inventory/debt_supplier') }}">
                            @csrf
                            <div class="row">
                                <div class="col-6">
                    ...
                    @if($data != null)
                    <form method="POST" action="{{ URL::to('inventory/export_debt_supplier') }}" class="float-right" target="_blank">
                        @csrf
                        <div hidden>
                        ...
                        <table style="border-collapse:collapse; width:100%">
                            ...
                            @foreach($data as $value)
                                ...
                                <tr id="table">
                                    ...
                                    <td><a href="#" data-id="{{$value->m_supplier_id}}" onclick="getReport(this)" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Lihat Tagihan Supplier">{{$value->name}}</a></td>
...
<div class="modal fade bs-example-modal-lg" id="modalBillDetail" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            ...
            @csrf
            <div class="modal-header">
                <h4 class="modal-title" id="title-modal">Laporan Hutang Supplier </h4>
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
            </div>
            <div class="modal-body">
                <input type="hidden" name="giro_id" id="giro_id">
                <div class="form-group">
                    <label for="">Total Laporan Hutang Supplier :</label>
