    ...
    <div class="row">
        <div class="col-12">
            <div class="text-right">
                <a href="{{ URL::to('payment/add_payment_charge') }}"><button class="btn btn-success btn-sm mb-2"><i class="fas fa-plus"></i>&nbsp; Create New</button></a>
            </div>
            <div class="card">
                <div class="card-body">
...
$(document).ready(function() {
    $('#order_list').DataTable( {
        "processing": true,
        "serverSide": true,
        "ajax": "{{ URL::to('payment/list_payment_charge') }}",
        "aaSorting": [[ 0, "desc" ]],
        "columns": [
