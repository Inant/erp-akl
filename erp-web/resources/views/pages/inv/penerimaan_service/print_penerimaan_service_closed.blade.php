...
<head>
    ...
    <title>Print Surat Penerimaan Jasa</title>
...
<body class="page" onload="window.print()">
    ...
    <table class="table">
        <tr>
            <td width="50%"><h3 class="title-print">SURAT PENERIMAAN JASA<h3></td>
            <td width="50%" class="text-right"><img hidden src="{!! asset('theme/assets/images/img_01.png') !!}" alt="logo" class="dark-logo" /></td>
        </tr>
    </table>
    <!-- Header -->
    <table class="table">
        <tr>
            <td width="50%">Nomer : {{ $purchase['inv_trx'] != null ? $purchase['inv_trx']->no : '' }}</td>
        ...
        <tr>
            <td width="50%">Nomor Surat Jalan : {{ $purchase['inv_trx'] != null ? $purchase['inv_trx']->no : '' }}</td>
    ...
    <table class="table bordered">
        ...
        @if(count($purchase_d) > 0)
            ...
            <tr>
                ...
                <td class="text-center">{{ $purchase_d[$i]->service_name }}</td>
