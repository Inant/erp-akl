        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <!-- <div class="row"> -->
                        <form method="POST" action="{{ URL::to('inventory/piutang_all') }}">
                            @csrf
                            <div class="row">
                                <div class="col-6">
                    ...
                    <br><br>
                    @if($data_cust != null)
                    <form method="POST" action="{{ URL::to('inventory/export_piutang_all') }}" class="float-right" target="_blank">
                        @csrf
                        <div hidden>
