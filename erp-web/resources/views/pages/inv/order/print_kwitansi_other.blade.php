...
<body class="page" onload="window.print()" style="padding:30px; border:1px solid black; margin:10px">
  <div>
    ...
    <br>
    <?php
    $ppn=$cust_bill['amount']*0.1;
    $pph=$cust_bill['with_pph'] == true ? $cust_bill['amount'] * 0.02 : 0;
    $total=$cust_bill['amount']+($ppn - $pph);
    $nilainya = round($total);
    ?>
    <table>
        <thead>
            <tr>
    ...
    <table style="width:100%;">
        <thead>
            ...
            <tr>
                ...
                <td style="padding-bottom:10px; font-size:16px;">{{terbilang($nilainya)}} rupiah</td>
    ...
    <table style="width:100%">
        <thead>
            ...
            <tr>
                ...
                <td style="width:10%;padding:10px 0 10px 0; border-top:1px solid black; border-bottom:1px solid black" align="right"><b>{{number_format($total, 0, '.', '.')}}</b></td>
                <td style="width:30%;"></td>
