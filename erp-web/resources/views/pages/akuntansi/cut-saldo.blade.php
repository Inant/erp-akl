            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-5 align-self-center">
                        <h4 class="page-title">Cut Saldo</h4>
        ...
        <div class="col-6">
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        <div class="col-12">
                            <h4>Cut Saldo Rentang Bulan</h4>
                            <form method="POST" action="{{ URL::to('akuntansi/cutSaldoYear') }}" class="form-group">
                              @csrf
                              <div class="row">
                                <div class="col-6">
        ...
        <div class="col-6">
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        <div class="col-12">
                            <h4 id="titleJurnal">Cut Saldo per Bulan</h4>
                            <form method="POST" action="{{ URL::to('akuntansi/cut-saldo') }}" class="form-group">
                              @csrf
                              <div class="row">
...
<script type="text/javascript">
    ...
    $('#titleJurnal').html('Cut Saldo Bulan '+formatBulan(bulan));
