...
@section('content')
                                ...
                                <form method="POST" action="{{ $menu_by_id != null ? URL::to('menu/edit/'.$menu_by_id->id) : route('menu/add') }}" class="needs-validation" novalidate>
                                  ...
                                  <div class="form-row">
                                    <div class="col-md-12 mb-3">
                                      ...
                                      <select name="is_main_menu" id="is_main_menu" required class="form-control select2 custom-select" style="width: 100%; height:32px;">
                                  ...
                                  <div class="form-row">
                                    <div class="col-md-12 mb-3">
                                      <label for="validationTooltip01">Is Page</label>
                                      <!-- <input type="text" class="form-control" id="validationTooltip01" placeholder="Is Main Menu" required> -->
                                      <select name="is_page" id="is_page" class="form-control select2 custom-select" style="width: 100%; height:32px;">
                                        @if($menu_by_id==null || $menu_by_id!=null && !isset($page))
                                            <option value="">Select Is Page</option>
                                        @else
 ...
 <script>
  $(document).ready(function(){
    $("#is_main_menu").change(function(){
      var thisVal = $(this).val()
      $.ajax({
        type : "get",
        url : "{{ URL::to('menu/menuByMainMenu') }}",
        data : {"is_main_menu" : thisVal},
        success : function(data){
          $("#is_page option").remove()
          $("#is_page").append(data)
        }
      })
    })
