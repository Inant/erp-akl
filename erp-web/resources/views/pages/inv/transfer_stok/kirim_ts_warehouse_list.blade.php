    ...
    <!-- basic table -->
                <div class="row">
                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">List Pengiriman Transfer Stok Gudang</h4>
...
$(document).ready(function(){
    $('#transfer_list').DataTable( {
        "processing": true,
        "serverSide": true,
        "ajax": "{{ URL::to('transfer_stok/list_kirim_ts_warehouse') }}",
        "columns": [
