...
function penyebut($nilai) {
  ...
  $ppn=$total_bill * 0.1;
  $pph=$cust_bill['with_pph'] == true ? ($total_bill * 0.02) : 0;
  $total_payment=$total_bill + ($ppn - $pph);
?>
  ...
  <div style="padding-top:100px">
    ...
    <table style="width:100%;">
        ...
        <tr>
            ...
            <td></td>
            <td class="border">PPH (2%)</td>
            <td class="text-right border">Rp. {{number_format($pph)}}</td>
        </tr>
        <tr>
