    ...
    <div class="page-breadcrumb">
        <div class="row">
            <div class="col-5 align-self-center">
                <h4 class="page-title">Laba Rugi Sementara Kontrak</h4>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <div class="col-12">
                    <h4 class="card-title">Laba Rugi Sementara Kontrak</h4>
                        <form method="POST" action="{{ URL::to('akuntansi/temp_profit_loss_kontrak') }}">
                                @csrf
                            <div class="row"> 
                                <div class="col-6">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered">
                                <thead style="background-color:#3c8dbc; color:white">
                                    <tr>
                                        <th>Nilai Kontrak</th>
                                        <th colspan="2" class="text-right">Rp. {{formatRupiah($nilaiKontrak)}}</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr style="background-color:#ddd">
                                        <th>Total Nilai Pendapatan</th>
                                        <th colspan="2" data-toggle="collapse" href="#collapseExample" aria-expanded="false" aria-controls="collapseExample" class="text-right"><p data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Klik untuk melihat detail">Rp. {{formatRupiah($sum_pendapatan)}}</p></th>
                                    </tr>
                                </tbody>
                                ...
                                {{-- <thead style="background-color:#3c8dbc; color:white">
                                    <tr>
                                        <th>Perkiraan Biaya Produksi</th>
                                        <th colspan="2" class="text-right">Rp. {{isset($rab) ? formatRupiah($rab->base_price) : 0}}</p></th>
                                    </tr>
                                </thead> --}}
                                ...
                                <tr style="background-color:#ddd">
                                    <th>Gross Profit</th>
                                    @php
                                        $biaya = isset($rab) ? $rab->base_price : 0;
                                    @endphp
                                    <th colspan="2" class="text-right">Rp. {{formatRupiah($sum_pendapatan - $data['biaya']->total)}}</th>
                                </tr>
                            </table>
                        </div>
                        @endif
