			...
			<div class="page-breadcrumb">
                <div class="row">
                    <div class="col-5 align-self-center">
                        <h4 class="page-title">Transfer Stok Gudang</h4>
                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        <div class="text-right">
                            <a href="{{ URL::to('transfer_stok/create_warehouse') }}"><button class="btn btn-success btn-sm mb-2"><i class="fas fa-plus"></i>&nbsp; New Transfer Stok</button></a>
                        </div>
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">List Transfer Stok Gudang</h4>
...
$(document).ready(function(){
    $('#transfer_list').DataTable( {
        "processing": true,
        "serverSide": true,
        "ajax": "{{ URL::to('transfer_stok/list_warehouse_ts') }}",
        "columns": [
            ...
            {"data": "id", "render": function(data, type, row){
                return '<button onclick="doShowDetail('+row.id+');" data-toggle="modal" data-target="#modalTransferDetail" class="btn waves-effect waves-light btn-sm btn-info openModalTransferDetail">Detail</button>&nbsp;<button type="button" onclick="clickPrint('+row.id+');" class="btn btn-warning waves-effect waves-light btn-sm">Print</button>'
            }, "class" : "text-center"}
        ],
    } );
});
...
function clickPrint(id) {
    setTimeout(() => {
        window.open("{{ URL::to('transfer_stok/surat_jalan_ts') }}" + "/" + id, '_blank')
    }, 500);
}
</script>
