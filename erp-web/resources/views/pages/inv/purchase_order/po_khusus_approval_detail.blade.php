                    ...
                    <div class="col-12">
                        ...
                        @csrf
                            ...
                            <div class="text-right">
                                ...
                                <a href="{{ URL::to('po_spesial_approval/decline/'.$purchase['id']) }}"><button type="button" class="btn btn-warning btn-sm mb-2">Decline</button></a>
                                <a href="{{ URL::to('po_spesial_approval/approve/'.$purchase['id']) }}"><button type="button" class="btn btn-primary btn-sm mb-2">Approve</button></a>
                            </div>
                            <div class="card">
                                <div class="card-body">
