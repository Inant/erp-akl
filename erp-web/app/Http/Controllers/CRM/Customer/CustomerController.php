...
class CustomerController extends Controller
{
    ...
    public function saveCustomer(Request $request)
    {
        ...
        DB::table('customers')->insert([
            ...
            'flag'                           => $request->flag,
            'plafond_piutang'               => $request->plafond_piutang,
            'jumlah_tagihan_maksimal'       => $request->jumlah_tagihan_maksimal,
    ...
    public function updateCustomer(Request $request, $id)
    {
        try {
            ...
            // cek apakah user mengubah plafond piutang atau jumlah tagihan maksimal
            if ($customer->plafond_piutang != $request->plafond_piutang || $customer->jumlah_tagihan_maksimal != $request->jumlah_tagihan_maksimal) {
                $dataUpdate = [
                    'coorporate_name'           => $request->coorporate_name,
                    'name'                      => $request->name,
                    'address'                   => $request->alamat,
