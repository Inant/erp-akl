                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form method="POST" action="{{ URL::to('employee/edit_post') }}" >
                              @csrf
                              <div class="form-row">
                                <div class="col-md-12 mb-3">
                                  <label>Nama Pegawai</label>
                                  <input type="hidden" class="form-control" name="id" value="{{$data->id}}">
                                  <input type="text" class="form-control" name="nama" required value="{{$data->name}}">
                              ...
                              <div class="form-row">
                                ...
                                <div class="col-md-12 mb-3">
                                  <select name="position_id" required class="form-control select2" style="width: 100%;">
                                        ...
                                        <option value="{{$value->id}}" {{$value->id == $data->position_id ? 'selected' : ''}}>{{$value->name}}</option>
                                        @endforeach
                                  </select>
                                </div>
                              </div>
                              <div class="form-row">
                                ...
                                <div class="col-md-12 mb-3">
                                  <select name="site_id" required class="form-control select2" style="width: 100%;">
                                        ...
                                        <option value="{{$value->id}}" {{$value->id == $data->site_id ? 'selected' : ''}}>{{$value->name}}</option>
                                        @endforeach
                                  </select>
                                </div>
                              </div>
