        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ URL::to('master_worksub/edit/'.$worksub['id']) }}" class="form-horizontal">
                        @csrf
                        <div class="form-group row">
                            <label class="col-sm-3 text-right control-label col-form-label">Name</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" name="name" value="{{$worksub['name']}}"/>
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="" class="form-control" name="amount" id="amount" value="{{$worksub['price']}}" onkeyup="cekFormat(this.value)"/>
                            </div>
                        </div>
    ...
    $.ajax({
        ...
        success: function(response){
            ...
            for(i = 0; i < arrData.length; i++){
                formSatuan.append('<option value="'+arrData[i]['id']+'" '+(unit_id == arrData[i]['id'] ? "selected" : '')+'>'+arrData[i]['name']+'</option>');
