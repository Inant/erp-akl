        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        <div class="col-12">
                            <h4 class="box-title">Neraca per Tanggal {{formatDate($data['date1'])}} Sampai {{formatDate($data['date2'])}}</h4>
                            ...
                            <div class="form-inline">
                                ...
                                href="{{ URL::to('akuntansi/export_neraca?date='.$data['date1'].'&date2='.$data['date2']) }}" >
                        ...
                        <table style="border-collapse:collapse" class="floatLeft">
                            <thead id="table">
                                <tr>
                                    ...
                                    <!-- <th rowspan="2" style="vertical-align : middle;text-align:center;">Saldo Awal Bulan</th>
                                    <th rowspan="2" style="vertical-align : middle;text-align:center;">Perubahan Saldo</th> -->
                                    <th rowspan="2" colspan="2" class="text-center">Saldo Akhir</th>
                                </tr>
                            </thead>
                            <tbody>
                                @php 
                                $jumlah_debit=$jumlah_kredit=$total_debit=$total_kredit=$initiate=0;
                                // echo $data['hppProduksi'];
                                @endphp
                                @foreach ($data['parent'] as $k)
                                    <?php
                                    $temp=array();
                                    ...
                                    <tr id="table" >
                                        ...
                                        <tr id="table" >
                                            ...
                                            <!-- <td class="text-right">Rp. {{formatRupiah(($saldo != null ? $saldo->jumlah_saldo : 0))}}</td> -->
                                            @php
                                        ...
                                        <tr id="table" >
                                            <th colspan="2" class="text-center"><b>Total Akumulasi Penyusutan</b></th>
                            ...
                            <thead id="table">
                                <tr>
                                    <th rowspan="2" colspan="4" style="border-left:1px solid white;border-right:1px solid white;color:white">No Akun</th>
                                </tr>
                            </thead>
                            <thead id="table">
                                <tr>
                            ...
                            <tbody>
                                ...
                                @foreach ($data['parent'] as $k)
                                    ...
                                    @endforeach
                                    <tr id="table" >
                                        {{-- <th colspan="2" class="text-center" style="color:white"><b>asdfasdf</b></th> --}}
                                        <th colspan="2" class="text-center"><b></b></th>
                                    </tr>
                                    <?php
                                    $sub_total_parent=0;
