...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">General Ledger Akun {{$akun->nama_akun}}</h4>
                    <form method="POST" action="{{ URL::to('akuntansi/detail-gl/'.$id) }}" class="form-inline float-right">
                        @csrf
                        ...
                        <table class="table table-bordered" id="">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center">No Sumber</th>
                            ...
                            <?php $sub_total=($saldo_awal->jumlah_saldo != null ? $saldo_awal->jumlah_saldo : 0) + $saldo_before_start_date?>
                            <tbody>
                                <tr>
                            ...
                            <tbody>
                                ...
                                @else
                                    ...
                                    ?>
                                    <tr @if($v->id_trx_akun_detail == $selected) class="bg-warning text-white" @endif>
