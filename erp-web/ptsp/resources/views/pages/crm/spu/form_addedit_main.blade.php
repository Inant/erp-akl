			...
			<div class="page-breadcrumb">
                <div class="row">
                    <div class="col-5 align-self-center">
                        <h4 class="page-title">SPU RECORDS</h4>
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="{{ URL::to('unittransaction') }}">SPU RECORDS</a></li>
...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-12">
            @if ($mode=="edit")
            <form method="POST" action="{{ URL::to('spurecord/main/edit/'.$sale_trxes['id']) }}" class="form-horizontal">
            @else
            <form method="POST" action="{{ URL::to('spurecord/main/add') }}" class="form-horizontal">
            @endif
            @csrf
                <!--<div class="form-group mb-0 text-right" style="margin-top:10px;">-->
                <!--    <a href="{{ URL::to('spurecord') }}"><button type="button" class="btn btn-danger btn-sm mb-2">Cancel</button></a>-->
                <!--    <button type="submit" class="btn btn-info btn-sm mb-2">Save</button>-->
                <!--</div>-->
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">SPU Record</h4>
                    </div>
                    <hr>
                    <div class="card-body">
                        <h4 class="card-title">Transaction Data</h4>
                        <div class="form-group row align-items-center mb-0">
                            <label for="saletrx_no" class="col-sm-2 text-right control-label col-form-label">SPU No</label>
                            <div class="col-sm-4 border-left pb-2 pt-2">
                                ...
                                <input type="text" class="form-control" id="trx_type" name="trx_type" hidden="true" value="SPU">
                            </div>
                        ...
                        <div class="form-group row align-items-center mb-0">
                            <label for="owner_name" class="col-sm-2 text-right control-label col-form-label">Asset Owner Name</label>
                            <div class="col-sm-4 border-left pb-2 pt-2">
                        ...
                        <div class="form-group row align-items-center mb-0">
                            ...
                            <div class="col-sm-4 border-left pb-2 pt-2">
                                <select name="nupno" id="nupno"onchange="setNupRelatedData(this.value);" class="form-control select2 custom-select" style="width: 100%; height:32px;"  >
                        ...
                        <div class="form-group row align-items-center mb-0">
                            <label class="col-sm-2 text-right control-label col-form-label">Harga dasar kavling</label>
                            <div class="col-sm-4 border-left pb-2 pt-2">
                        ...
                        <div class="form-group row align-items-center mb-0">
                            <label for="notary_amount" class="col-sm-2 text-right control-label col-form-label">Biaya Notaris</label>
                            <div class="col-sm-4 border-left pb-2 pt-2">
                        ...
                        <div class="form-group row align-items-center mb-0">
                            ...
                            <div class="col-sm-4 border-left pb-2 pt-2">
                                <select name="payment_method" class="form-control select2 custom-select" style="width: 100%; height:32px;"  onchange="selectedPaymentTypeChanged(this.value)">
                        ...
                        @if($doc_lists['KPR'] != null)
                        <div id="div_doc_lists_kpr" >
                            <div class="form-group row align-items-center mb-0">
                                <label class="col-sm-2 text-right control-label col-form-label">KPR Documents CheckList</label>
                                <input type="number" name="kpr_doc_count" value="{{ count($doc_lists['KPR']) }}" hidden="true">
                            </div>
                             <div class="form-group row align-items-center mb-0">
                                <label class="col-sm-2 text-right control-label col-form-label"> </label>
                                <table id="zero_config1" class="table table-striped table-bordered col-sm-6">
                                    <thead>
                                        <tr>
                                            <th class="text-center">No</th>
                                            <th class="text-center">Doc Name</th>
                                            <th class="text-center">Is Checked</th>
                                            <th class="text-center">Tanggal Jatuh Tempo</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        @for($i = 0; $i < count($doc_lists['KPR']); $i++)
                                        <tr>
                                            <td class="text-center">{{ $i+1 }}</td>
                                            <td>{{$doc_lists['KPR'][$i]['name'] }}
                                                <input type="number" name="{{'kpr_doc_type_id_'.$i}}" value="{{$doc_lists['KPR'][$i]['id'] }}" hidden="true" /> 
                                                <input type="number" name="{{'kpr_doc_id_'.$i}}" value="{{$sale_trxes['doc_kpr'][$i]['id'] }}" hidden="true">
                                            </td>
                                            <td>
                                                <input type="checkbox" class="form-control text-center" id="{{'kpr_doc_is_checked_'.$i}}" name="{{'kpr_doc_is_checked_'.$i}}" value="true" 
                                                @if( $sale_trxes['doc_kpr'][$i]['is_checked'] == true ) checked="true" @endif onclick="checkDueDate(this)"
                                                />
                                            </td>
                                            <td>
                                                <input type="date" class="form-control text-center" id="{{'kpr_doc_due_date_'.$i}}" name="{{'kpr_doc_due_date_'.$i}}" value="{{$sale_trxes['doc_kpr'][$i]['due_date'] }}"
                                                @if( $sale_trxes['doc_kpr'][$i]['is_checked'] == true ) disabled="true" @endif
                                                />
                                            </td>
                                        </tr>
                                        @endfor
                        ...
                        @endif
                        @if($doc_lists['AJB'] != null)
                        <div id="div_doc_lists_kpr" >
                            <div class="form-group row align-items-center mb-0">
                                <label class="col-sm-2 text-right control-label col-form-label">AJB Documents CheckList</label>
                                <input type="number" name="ajb_doc_count" value="{{ count($doc_lists['AJB']) }}" hidden="true">
                            </div>
                             <div class="form-group row align-items-center mb-0">
                                <label class="col-sm-2 text-right control-label col-form-label"> </label>
                                <table id="zero_config2" class="table table-striped table-bordered col-sm-6">
                                    <thead>
                                        <tr>
                                            <th class="text-center">No</th>
                                            <th class="text-center">Doc Name</th>
                                    ...
                                    <tbody>
                                        @for($i = 0; $i < count($doc_lists['AJB']); $i++)
                                        <tr>
                                            <td class="text-center">{{ $i+1 }}</td>
                                            <td>{{$doc_lists['AJB'][$i]['name'] }}
                                                <input type="number" name="{{'ajb_doc_type_id_'.$i}}" value="{{$doc_lists['AJB'][$i]['id'] }}" hidden="true" /> 
                                                <input type="number" name="{{'ajb_doc_id_'.$i}}" value="{{ $sale_trxes['doc_ajb'][$i]['id'] }}" hidden="true">
                                            </td>
                                            <td>
                                                <input type="checkbox" class="form-control text-center" id="{{'ajb_doc_is_checked_'.$i}}" name="{{'ajb_doc_is_checked_'.$i}}" value="true"
                                                @if( $sale_trxes['doc_ajb'][$i]['is_checked'] == true ) checked="true" @endif onclick="checkDueDate(this)"
                                                />
                                            </td>
                                            <td>
                                                <input type="date" class="form-control text-center" id="{{'ajb_doc_due_date_'.$i}}" name="{{'ajb_doc_due_date_'.$i}}" value="{{$sale_trxes['doc_ajb'][$i]['due_date'] }}" 
                                                @if( $sale_trxes['doc_ajb'][$i]['is_checked'] == true ) disabled="true" @endif
                                                />
                                            </td>
                                        </tr>
                                        @endfor
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <a href="{{ URL::to('spurecord') }}"><button type="button" class="btn btn-danger mb-2">Cancel</button></a>
...
function setNupRelatedData(nup_id)
{
    $.ajax({
        ...
        success: function(response){
            ...
            $("#txt_nup_amount").val(arrData['cash_amount']).change();
...
function updatePrice()
{
    ...
    os_amount =   kavling_price - booking_amount + ppn_amount + bphtb_amount + fasumamount + notaryamount + specup_amount;
