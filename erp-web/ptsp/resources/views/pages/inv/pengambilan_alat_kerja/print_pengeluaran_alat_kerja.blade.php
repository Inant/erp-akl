...
<head>
    ...
    <title>Print Bukti Pengeluaran Alat Bantu Kerja</title>
...
<body class="page" onload="window.print()">
    ...
    <table class="table">
        <tr>
            <td width="50%"><h3 class="title-print">BUKTI PENGELUARAN ALAT BANTU KERJA<h3></td>
    ...
    <table class="table">
        ...
        <tr>
            <td width="50%">Untuk Site : {{ $inv_request['site'] != null ? $inv_request['site']['name'] : '' }}</td>
            <td width="50%"></td>
        </tr>
        <tr>
    ...
    <table class="table bordered">
        <tr>
            ...
            <th class="text-center">Nomor Alat Bantu Kerja</th>
            <th class="text-center">Alat Bantu Kerja</th>
