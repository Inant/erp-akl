			...
			<div class="page-breadcrumb">
                <div class="row">
                    <div class="col-5 align-self-center">
                        <h4 class="page-title">Pembayaran Hutang Usaha</h4>
    ...
    <div class="row">
        ...
        <div class="col-12">
            <div class="text-right">
                <a href="{{ URL::to('payment/form_paid_debt') }}"><button class="btn btn-success btn-sm mb-2"><i class="fas fa-plus"></i>&nbsp; Create New</button></a>
            </div>
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Pembayaran Hutang Usaha</h4>
...
$(document).ready(function() {
    $('#paid_list').DataTable( {
        "processing": true,
        "serverSide": true,
        "ajax": "{{ URL::to('/payment/list_paid_debt') }}",
        'aaSorting' : [3, 'desc'],
        "columns": [
    ...
    $('#listDetailAll').DataTable( {
        "processing": true,
        "serverSide": true,
        "ajax": "{{ URL::to('payment/list_detail_all') }}",
        'aaSorting' : [2, 'desc'],
        "columns": [
            {"data": "debt_no", "class" : "text-center"},
...
function doShowDetail(eq){
    ...
    t2.clear().draw(false);
    $.ajax({
        url: "{{ URL::to('payment/get_paid_debt_detail') }}"+'/'+eq,
        dataType : 'json',
