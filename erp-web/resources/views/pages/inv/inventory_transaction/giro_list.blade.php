			...
			<div class="page-breadcrumb">
                <div class="row">
                    <div class="col-5 align-self-center">
                        <h4 class="page-title">Pencairan Giro</h4>
...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Daftar Pencairan Giro</h4>
    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h4 class="modal-title" id="title-modal">Pencairan Giro </h4>
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
            </div>
            <div class="modal-body">
                <input type="hidden" name="giro_id" id="giro_id">
                <div class="form-group">
                    <label for="">Total Pencairan Giro :</label>
...
$(document).ready(function(){
    $.ajax({
        ...
        success: function(response){
            arrData = response;
            arrData.push({'label' : 96, 'value' : '8.4.1.0 | Biaya Admin Bank'})
    ...
    $('#giro_list').DataTable( {
        ...
        "columns": [
            ...
            {"data": "paid_cust", "class" : "text-center",
            "render": function(data, type, row){return row.paid_cust != null ? row.paid_cust.no : '-'}},
