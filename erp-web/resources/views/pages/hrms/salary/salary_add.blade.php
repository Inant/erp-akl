			...
			<div class="page-breadcrumb">
                <div class="row">
                    <div class="col-5 align-self-center">
                        <h4 class="page-title">Tambah Setting Gaji</h4>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form method="POST" action="{{ URL::to('salary/add_post') }}" >
                              @csrf
                              <div class="form-row">
                                <div class="col-12">
                              ...
                              <div class="form-row">
                                <div class="col-md-12 mb-3">
                                  ...
                                  <input type="text" class="form-control" name="gaji_pokok" id="gaji_pokok" required onkeyup="cekGaji(this.value)">
                                </div>
                              </div>
                              <div class="form-row">
                                <div class="col-md-12 mb-3">
                                  <label>Uang Makan</label>
                                  <input type="text" class="form-control" name="uang_makan" id="uang_makan" required onkeyup="cekUangMakan(this.value)">
                                </div>
                              </div>
                              <div class="form-row">
                                <div class="col-md-12 mb-3">
                                  <label>Uang Transport</label>
                                  <input type="text" class="form-control" name="uang_transport" id="uang_transport" required onkeyup="cekUangTransport(this.value)">
                                </div>
                              </div>
                              <div class="form-row">
                                <div class="col-md-12 mb-3">
                                  <label>Denda Absen</label>
                                  <input type="text" class="form-control" name="denda" id="denda" required onkeyup="cekDenda(this.value)">
                                </div>
                              </div>
                              <div class="form-row">
                                <div class="col-md-12 mb-3">
                                  <label>Denda Telat</label>
                                  <input type="text" class="form-control" name="denda_telat" id="denda_telat" required onkeyup="cekDendaTelat(this.value)">
                                </div>
                              </div>
