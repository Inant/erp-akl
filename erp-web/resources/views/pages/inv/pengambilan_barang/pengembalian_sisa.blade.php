...
<form method="POST" action="{{ URL::to('material_request/returnadd') }}" class="form-horizontal">
            ...
            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <h4 class="card-title">Pengembalian Material Detail</h4>
                        <div>
                            ...
                            <table id="requestDetail_addrow" class="table table-striped table-bordered display" style="width:100%">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center">Qty Request dari RAP</th>
    ...
    <!-- <div class="modal fade" id="modalShowDeta" tabindex="-1" role="dialog" aria-labelledby="modalShowDetailLabel1">
...
$('#addRow').on('click', function() {
    t.row.add([
        ...
        '<input type="number" id="qty_req[]" name="qty[]" step="any" min="0" class="form-control text-right" placeholder="0" required onkeyup="cekQty()">',
            ...
            if(selectedMaterial == arrMaterial[i]['id']){
                ...
                for(j = 0; j < listMaterialRab.length; j++) {
                    if(arrMaterial[i]['id'] == listMaterialRab[j]['m_item_id']) {
                        ...
                        qty_sisa_rab = parseFloat(listMaterialRab[j]['used_amount']);
                    }
                }
                formQtyRab.val(qty_rab);
                formQtySisaRab.val(qty_sisa_rab);
                if (qty_sisa_rab == 0) {
                    formMaterial.val('').change();
                    alert('Jumlah Material Request masih kosong');
                }
            }     
        });
...
function cekQty(){
    var qty = $('[id^=qty_sisa_rab]');
    var qty_req = $('[id^=qty_req]');
