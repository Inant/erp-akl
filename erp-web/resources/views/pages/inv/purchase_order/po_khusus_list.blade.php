			...
			<div class="page-breadcrumb">
                <div class="row">
                    <div class="col-5 align-self-center">
                        <h4 class="page-title">PO Khusus</h4>
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item active" aria-current="page">PO Khusus</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
    ...
    <!-- basic table -->
                <div class="row">
                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">List Purchase Order Khusus</h4>
...
$(document).ready(function(){
    ...
    $.ajax({
            type: "GET",
            url: "{{ URL::to('po_spesial/all') }}", //json get site
            dataType : 'json',
            success: function(response){
                ...
                for(i = 0; i < arrData.length; i++){
                    t.row.add([
                        ...
                        '<div class="text-center">'+(arrData[i]['is_apv'] == null ? "Requested" : (arrData[i]['is_apv'] == false ? "Declined" : "Approved"))+'</div>',
                        '<div class="text-center">'+(arrData[i]['apv_date'] != null ? (arrData[i]['apv_date']).substring(0,10) : "-")+'</div>',
                        '<div class="text-center">'+(arrData[i]['apv_by'] != null ? arrData[i]['apv_by'] : "-")+'</div>',
                        '<div class="text-center"><button type="button" onclick="doShowDetail('+arrData[i]['id']+');" data-toggle="modal" data-target="#modalShowDetail" class="btn btn-info waves-effect waves-light btn-sm">Detail</button></div>'
                    ]).draw(false);
                }
            }
    });
