			...
			<div class="page-breadcrumb">
                <div class="row">
                    <div class="col-5 align-self-center">
                        <h4 class="page-title">Pembayaran Tagihan Pengadaan/Pemasangan</h4>
    ...
    <div class="row">
        ...
        <div class="col-12">
            <div class="text-right">
                <a href="{{ URL::to('payment/form_paid_bill_vendor') }}"><button class="btn btn-success btn-sm mb-2"><i class="fas fa-plus"></i>&nbsp; Create New</button></a>
            </div>
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Pembayaran Tagihan Pengadaan/Pemasangan</h4>
...
<div class="modal fade bs-example-modal-lg" id="modalListDetail" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="table-responsive">
                    <table id="listDetailAll" class="table table-striped table-bordered" style="width:100%">
                        <thead>
                            <tr>
...
$(document).ready(function() {
    $('#paid_list').DataTable( {
        "processing": true,
        "serverSide": true,
        "ajax": "{{ URL::to('/payment/list_paid_bill_vendor') }}",
        'aaSorting' : [3, 'desc'],
        "columns": [
    ...
    $('#listDetailAll').DataTable( {
        "processing": true,
        "serverSide": true,
        "ajax": "{{ URL::to('payment/bill_vendor_detail_all') }}",
        'aaSorting' : [2, 'desc'],
        "columns": [
            {"data": "bill_vendor_no", "class" : "text-center"},
...
function doShowDetail(eq){
    ...
    t2.clear().draw(false);
    $.ajax({
        url: "{{ URL::to('payment/get_paid_bill_vendor') }}"+'/'+eq,
        dataType : 'json',
