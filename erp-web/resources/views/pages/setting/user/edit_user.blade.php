        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form method="post" action="{{ URL::to('user/edituser') }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div id="form-1" class="form-row hide">
                            <div class="col-md-12 mb-3">
                                <label>Sales</label>
                        ...
                        <div class="form-row">
                            <div class="col-md-12 mb-3">
                                ...
                                <select name="site" class="form-control" required onchange="getGudang(this)">
                                    ...
                                    @for($i=0; $i < count($site); $i++) @if($site[$i]['id']==$value[0]->site_id)
                        ...
                        <div class="form-row">
                            <div class="col-md-12 mb-3">
                                ...
                                <select name="m_warehouse_id" id="m_warehouse_id" class="form-control">
                                    ...
                                    <option value="{{$data->id}}" {{$value[0]->m_warehouse_id == $data->id ? 'selected' : '' }}>{{$data->name}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
...
<script>
    function salesForm() {
        ...
        if (jab == 7) {
            $('#form-1').show();
            $("#sales").attr("required", true);
        } else {
            $('#form-1').hide();
            $("#sales").attr("required", false);
        }
    }
