...
namespace App\Http\Controllers\CRM\SPU;
...
class SpuRecord extends Controller
{
    ...
    {       
        ...
        return view('pages.crm.spu.list_main', $data);
    }
    ...
    public function addedit($subcat, $mode, $id=null)
    {
        ...
        return view('pages.crm.spu.form_addedit_'.$subcat, $data);
    }
    ...
    public function addeditSubmit(Request $request,$subcat, $mode, $id=null)
    {
        ...
        try
        {
            ...
            {  
                ...
                $saleTrx['sale_trx_id'] = $request['nupno'];
    ...
    public function print($id) 
    {
        ...
        return view('pages.crm.spu.print_spu', $data);
    }
}