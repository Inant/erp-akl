    ...
    <div class="page-breadcrumb">
        <div class="row">
            <div class="col-5 align-self-center">
                <h4 class="page-title">Ringkasan Umur Piutang</h4>
...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Daftar Ringkasan Umur Piutang</h4>

                        <br><br>
                        <form method="POST" action="{{ URL::to('inventory/export_ringkasan_umur_piutang') }}"
                                ...
                                <tbody>
                                    @foreach ($data as $value)
                                        @if ($value->detail->total_in_one_months > 0 || $value->detail->total_in_two_months > 0 || $value->detail->total_in_three_months || $value->detail->total_in_four_months || $value->detail->total_in_five_months > 0)
                                            ...
                                            @endphp
                                            <tr>
                                                <td class="text-center">{{ $value->coorporate_name }}</td>
        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="title-modal">Rincian Tagihan Piutang </h4>
    ...
    <script>
        ...
        function doShowDetail(eq) {
            ...
            $.ajax({
                type: "post",
                url: "{{ URL::to('inventory/ringkasan_umur_piutang_json') }}",
                dataType: 'json',
                data: {
                    _token: CSRF_TOKEN,
                    id: id,
