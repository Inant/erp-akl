            ...
            <div class="col-5 align-self-center">
                ...
                <div class="d-flex align-items-center">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item active" aria-current="page">Master Pekerjaan</li>
                        </ol>
                    </nav>
                </div>
            </div>
    ...
    <div class="row">
        <div class="col-12">
            <div class="text-right">
                <a href="{{ URL::to('master_worksub/create') }}"><button class="btn btn-success btn-sm mb-2"><i class="fas fa-plus"></i>&nbsp; Create New</button></a>
            </div>
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">List Master Pekerjaan</h4>
                        ...
                        <table id="material_list" class="table table-striped table-bordered">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center">Biaya Pekerjaan</th>
...
$(document).ready(function() {
    $('#material_list').DataTable( {
        "processing": true,
        "serverSide": true,
        "ajax": "{{ URL::to('master_worksub/list') }}", //json get site
        aaSorting: [[3, 'desc']],
        "columns": [
            {"data": "name"},
            {"data": "m_units.name"},
            {"data": "price",  'class' : 'text-right',
                "render" : function(data, type, row){ return formatCurrency(row.price)}
            },
            {"data": "id", 
            "render" : function(data, type, row){ return row.action}
            }
        ],
    } );
});
