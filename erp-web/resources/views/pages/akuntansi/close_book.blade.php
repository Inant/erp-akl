            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-5 align-self-center">
                        <h4 class="page-title">Tutup Buku</h4>
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-12">
                            ...
                            <form method="POST" action="{{ URL::to('akuntansi/close-book') }}" class="form-group">
                              @csrf
                              <div class="row">
...
<script type="text/javascript">
    ...
    $('#titleJurnal').html('Tutup Buku Bulan '+formatBulan(bulan));
