...
<body class="page" onload="window.print()">
    ...
    <table class="table">
        ...
        <tr>
            <td width="50%">Nomor Surat Jalan : {{ $purchase['inv_trx'] != null ? $purchase['inv_trx'][0]['no_surat_jalan'] : '' }}</td>
    ...
    <table class="table">
        ...
        <tr>
            <td width="50%">{{ $purchase['inv_trx'] != null ? $purchase['inv_trx'][0]['ekspedisi'] : '' }}</td>
