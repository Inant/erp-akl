...
<head>
    ...
    <!-- Custom CSS -->
    <script src="{!! asset('theme/dist/js/jquery_3.1.0.min.js') !!}"></script>
    <script src="{!! asset('theme/dist/js/jquery-ui.js') !!}"></script>
    <link rel="stylesheet" href="{!! asset('theme/dist/css/jquery-ui.css') !!}" />
    ...
    <!-- <link href="{!! asset('theme/dist/css/styler.css') !!}" rel="stylesheet"> -->
    ...
    <div id="main-wrapper">
        ...
        <div class="page-wrapper">
            ...
            <footer class="footer text-center">
				Copyright <a href="https://primtech.co.id">CV Panca Prima</a>.
			</footer>
            <!-- ============================================================== -->
            <!-- End footer -->
            <!-- ============================================================== -->
