            ...
            success: function(response){
                ...
                for(i = 0; i < arrData.length; i++){
                    t.row.add([
                        ...
                        '',
                        '',
                        '<button type="button" data-name="'+arrData[i]['name']+'" data-product-id="'+arrData[i]['product_id']+'" data-id="'+arrData[i]['id']+'" title="Edit Work Detail" onclick="doEditWorkHeader(this);" data-toggle="modal" data-target="#modalEditWorkHeader" class="btn btn-success waves-effect waves-light btn-sm"><i class="mdi mdi-pencil"></i></button>'
                    ]).draw(false);
