			...
			<div class="page-breadcrumb">
                <div class="row">
                    <div class="col-5 align-self-center">
                        <h4 class="page-title">Purchase Order ATK dengan Ao</h4>
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item active" aria-current="page">Purchase Order ATK dengan AO</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
...
$(document).ready(function(){
    ...
    $(document).ready(function() {
        $('#po_list').DataTable( {
            "processing": true,
            "serverSide": true,
            "ajax": "{{ URL::to('po_konstruksi/all_ao_asset') }}",
            aaSorting: [[0, 'desc']],
            "columns": [
                {"data": "no"},
                {"data": "spk_number"},
