                        ...
                        if(project_worksub_id == arrProjectWorksub[j]['id']){
                            ...
                            for(k = 0; k < arrProjectWorksubD.length; k++){
                                t.row.add([
                                    ...
                                    '<div class="text-right">'+(arrProjectWorksubD[k]['amount_unit_child'] != null ? formatCurrency(arrProjectWorksubD[k]['amount_unit_child']) : '') + ' ' + (arrProjectWorksubD[k]['unit_child'] != null ? arrProjectWorksubD[k]['unit_child']['name'] : arrProjectWorksubD[k]['m_units']['name']) +'</div>',
                                    (arrProjectWorksubD[k]['qty_item'] != null ? arrProjectWorksubD[k]['qty_item'] : ''),
                                    '<div class="text-right">'+(arrProjectWorksubD[k]['base_price'] != null ? formatCurrency(parseFloat(arrProjectWorksubD[k]['base_price']).toFixed(0)) : '-')+'</div>',
                                    '<div class="text-right">'+(arrProjectWorksubD[k]['base_price'] != null ? formatCurrency(parseFloat(arrProjectWorksubD[k]['amount']).toFixed(0) * parseFloat(arrProjectWorksubD[k]['base_price']).toFixed(0)) : '')+'</div>',
    ...
    $.ajax({
            ...
            success: function(response){
                ...
                for(k = 0; k < arrData.length; k++){
                    total_price=Number(arrData[k]['amount']) * Number(arrData[k]['base_price']);
                    t.row.add([
                        ...
                        '<div class="text-right">'+(arrData[k]['base_price'] != null ? formatCurrency(parseFloat(arrData[k]['base_price']).toFixed(0)) : '-')+'</div>',
                        '<div class="text-right">'+(arrData[k]['base_price'] != null ? formatCurrency(total_price.toFixed(2)) : '')+'</div>'
                    ]).draw(false);
                }
            }
        });
